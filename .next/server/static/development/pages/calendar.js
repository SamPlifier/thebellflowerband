...
/* harmony import */ var _components_NumberOfEvents__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/NumberOfEvents */ "./components/NumberOfEvents.js");
...
class Calendar extends react__WEBPACK_IMPORTED_MODULE_4___default.a.Component {
  constructor(...args) {
    super(...args);
  ...
  componentDidMount() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('https://www.googleapis.com/calendar/v3/calendars/thebellflowerband%40gmail.com/events?key=AIzaSyA73ezNBuEPQSSjMgoMjfiFa5wwT1TJht8').then(res => {
  ...
  render() {
    ...
    return __jsx(_components_StyleBase__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      __self: this
    }, __jsx(_components_NumberOfEvents__WEBPACK_IMPORTED_MODULE_6__["default"], {
